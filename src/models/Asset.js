...
const AssetSchema = new Schema({
  ...
  equipment_type: { type: Schema.Types.ObjectId, ref: "Equipment_Type" },
  status: {
    type: String,
    index: true,
  ...
  asset_company: { type: Schema.Types.ObjectId, ref: "Asset_Company" },
  ...
  mobileDetail: { type: Schema.Types.ObjectId, ref: "AssetD_Mobile" },
  desktopDetail: { type: Schema.Types.ObjectId, ref: "AssetD_Desktop" },
