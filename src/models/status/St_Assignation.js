...
const St_AssignationSchema = new Schema({
  ...
  dateAssignation: {type: Date, unique: false, required: true }
});

St_AssignationSchema.index({ idAsset: 1, dateAssignation: 1 }, { unique: true });
