...
router.post("/danado", verifyToken, verifyRoles(["admin", "user_type_equipment"]), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, idAsset, tag, employeeNumber, fullNameEmployee, dateDamaged, ultimateStat, _yield$generateNewTag, newTag, auxTag, _generateTime, newDate, newDateUrl, investReport_url, receiPayment_url, st_damaged, investReport, receiPayment, rutaActaInv, rutaRecCobro;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _req$body = req.body, idAsset = _req$body.idAsset, tag = _req$body.tag, employeeNumber = _req$body.employeeNumber, fullNameEmployee = _req$body.fullNameEmployee, dateDamaged = _req$body.dateDamaged, ultimateStat = _req$body.ultimateStat; //obtengo los datos de la pagina
            _context3.prev = 1;
            _context3.next = 4;
          ...
          case 4:
            ...
            _generateTime = generateTime(dateDamaged), newDate = _generateTime.newDate, newDateUrl = _generateTime.newDateUrl;
            investReport_url = newDateUrl + "_" + newTag + ".pdf";
            receiPayment_url = newDateUrl + "_" + newTag + ".pdf";
            st_damaged = new St_DamagedSchema({
              idAsset: idAsset,
              dateDamaged: newDate,
          ...
          case 14:
            ...
            receiPayment = req.files.receiPayment;
            rutaActaInv = path.join(__dirname, "..", "respaldos", "/", "danados/acta_investigacion/");
            rutaRecCobro = path.join(__dirname, "..", "respaldos", "/", "danados/recibo_cobro/");
            ...
            receiPayment.mv(rutaRecCobro + receiPayment_url, /*#__PURE__*/function () {
          ...
          case 27:
            ...
            return _context3.abrupt("return", res.status(400).json({
              ok: false,
              status: "ERROR AL REGISTRAR DAÑADO"
            }));
          case 32:
...
router.get("/detalles_danado/:id", verifyToken, verifyRoles(["admin", "user_type_equipment", "user_read"]), /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            st_damaged = _context4.sent;
            return _context4.abrupt("return", res.status(200).json(st_damaged[0]));
          case 7:
            _context4.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            ruta = path.join(__dirname, "..", "respaldos", "/", "danados/acta_investigacion/", "".concat(req.params.investReport_url));
...
router.get("/ViewReceiPayment/:receiPayment_url", verifyToken, verifyRoles(["admin", "user_type_equipment", "user_read"]), /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            ruta = path.join(__dirname, "..", "respaldos", "/", "danados/recibo_cobro/", "".concat(req.params.receiPayment_url));
            res.status(200).download(ruta, function (err) {
              if (err) {
                return res.status(404).json("Pdf no encontrado");
              }
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            img = req.files.file;
            ruta = path.join(__dirname, "..", "respaldos", "/", "danados/acta_investigacion/");
...
router.post("/updateReceiPayment/", verifyToken, verifyRoles(["admin", "user_type_equipment"]), /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 2:
            img = req.files.file;
            ruta = path.join(__dirname, "..", "respaldos", "/", "danados/recibo_cobro/");
            img.mv(ruta + img.name, /*#__PURE__*/function () {
