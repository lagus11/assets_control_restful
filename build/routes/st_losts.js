...
var St_LostSchema = require("../models/status/St_Lost");
...
router.post("/extraviado", verifyToken, verifyRoles(["admin", "user_type_equipment"]), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, idAsset, tag, dateLost, employeeNumber, fullNameEmployee, _yield$generateNewTag, newTag, auxTag, _generateTime, newDate, newDateUrl, investReport_url, receiPayment_url, st_lost, investReport, receiPayment, rutaActaInv, rutaRecCobro;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _req$body = req.body, idAsset = _req$body.idAsset, tag = _req$body.tag, dateLost = _req$body.dateLost, employeeNumber = _req$body.employeeNumber, fullNameEmployee = _req$body.fullNameEmployee; //obtengo los datos de la pagina
            _context3.next = 3;
          ...
          case 3:
            ...
            _generateTime = generateTime(dateLost), newDate = _generateTime.newDate, newDateUrl = _generateTime.newDateUrl;
            investReport_url = newDateUrl + "_" + newTag + ".pdf";
            receiPayment_url = newDateUrl + "_" + newTag + ".pdf";
            st_lost = new St_LostSchema({
              idAsset: idAsset,
              dateLost: newDate,
          ...
          case 14:
            ...
            rutaActaInv = path.join(__dirname, "..", "respaldos", "/", "extraviados/acta_investigacion/");
            rutaRecCobro = path.join(__dirname, "..", "respaldos", "/", "extraviados/recibo_cobro/");
          ...
          case 27:
            ...
            return _context3.abrupt("return", res.status(400).json({
              ok: false,
              status: "ERROR AL REGISTRAR EXTRAVIADO"
            }));
          case 32:
          ...
          case 34:
            return _context3.abrupt("return", res.status(500).json({
              ok: false,
              status: "ERROR AL MANDAR EXTRAVIADO"
            }));
          case 35:
          case "end":
...
router.get("/detalles_extraviado/:id", verifyToken, verifyRoles(["admin", "user_type_equipment", "user_read"]), /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            st_lost = _context4.sent;
            return _context4.abrupt("return", res.status(200).json(st_lost[0]));
          case 7:
            _context4.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            ruta = path.join(__dirname, "..", "respaldos", "/", "extraviados/acta_investigacion/", "".concat(req.params.investReport_url));
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            ruta = path.join(__dirname, "..", "respaldos", "/", "extraviados/recibo_cobro/", "".concat(req.params.receiPayment_url));
            res.status(200).download(ruta, function (err) {
              if (err) {
                return res.status(404).json("Pdf no encontrado");
              }
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 2:
            img = req.files.file;
            rutaRecCobro = path.join(__dirname, "..", "respaldos", "/", "extraviados/recibo_cobro/");
            img.mv(rutaRecCobro + img.name, /*#__PURE__*/function () {
